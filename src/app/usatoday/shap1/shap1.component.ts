...
@Component({
  selector: 'my-liquid-circle',
  template: require('./liquid-circle.component.html'),
  changeDetection: ChangeDetectionStrategy.OnPush
})
// LiquidCircleComponent
export class Shap1Component implements OnInit, OnDestroy, AfterViewInit, OnChanges {
  ...
  initRenderer() {
    ...
    this.domRenderer.appendChild(this.canvas.nativeElement, this.renderer.view);
...
// WEBPACK FOOTER //
// ./~/angular2-template-loader!./~/@angularclass/hmr-loader!./~/tslint-loader!./src/app/home/components/liquid-circle/liquid-circle.component.ts